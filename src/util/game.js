...
function init_phaser(canvas) {
	//https://labs.phaser.io/edit.html?src=src/games/snake/part7.js&v=3.60.0
	...
	function create() {
		var Food = new Phaser.Class({
			...
			initialize: function Food(scene, x, y) {
				Phaser.GameObjects.Rectangle.call(this, scene);
		...
		var Snake = new Phaser.Class({
			initialize: function Snake(scene, x, y) {
				...
				this.scene.children.add(this.head);
			...
			grow: function () {
				...
				this.scene.children.add(newPart);
